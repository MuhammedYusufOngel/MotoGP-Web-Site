    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NationalId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NationalName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ManuChampId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ManuId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManuChamps", x => x.ManuChampId);
                    table.ForeignKey(
                        name: "FK_ManuChamps_Manufacturers_ManufacturerManuId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_Manufacturers_ManufacturerManuId",
                        column: x => x.ManufacturerManuId,
                        principalTable: "Manufacturers",
                        principalColumn: "ManuId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalId = table.Column<int>(type: "int", nullable: false),
                    RiderStory = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Drivers", x => x.DriverId);
                    table.ForeignKey(
                        name: "FK_Drivers_National_NationalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeamChampId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TeamId = table.Column<int>(type: "int", nullable: false),
                    Points = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamChamps", x => x.TeamChampId);
                    table.ForeignKey(
                        name: "FK_TeamChamps_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DriverChampId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DriverId = table.Column<int>(type: "int", nullable: false),
                    Points = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverChamps", x => x.DriverChampId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ManuChamps_ManufacturerManuId",
                table: "ManuChamps",
                column: "ManufacturerManuId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamChamps_TeamId",
                table: "TeamChamps",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_Teams_ManufacturerManuId",
                table: "Teams",
                column: "ManufacturerManuId");
        }
